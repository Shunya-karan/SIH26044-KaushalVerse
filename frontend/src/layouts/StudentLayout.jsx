...
import {
  LayoutDashboard, User, Code2, GitCompare, Route, Briefcase, FileText,
  FileCheck2, BarChart3, Bell, Settings, LogOut, Menu, X, ChevronDown,
} from 'lucide-react';
...
const sidebarItems = [
  ...
  { label: 'My Skills', to: '/student/skills', icon: Code2 },
  { label: 'Skill Gap', to: '/student/skill-gap', icon: GitCompare },
  { label: 'Learning Roadmap', to: '/student/roadmap', icon: Route },
  { label: 'Opportunities', to: '/student/opportunities', icon: Briefcase },
  { label: 'Applications', to: '/student/applications', icon: FileText },
  { label: 'Resume', to: '/student/resume', icon: FileCheck2 },
  { label: 'Career Insights', to: '/student/insights', icon: BarChart3 },
            ...
            <Link
              ...
              className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                isActive(item.to)
                  ...
                  : 'text-text-secondary hover:bg-bg hover:text-main'
              }`}
            >
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-white/90 backdrop-blur-md px-4 sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-text-secondary">Student Portal</span>
          </div>
          <div className="flex items-center gap-3">
